...
(use-package ddskk
  ...
  (skk-cursor-default-color "#cdd6f4")
  (skk-cursor-latin-color "#cdd6f4")
  (skk-cursor-hiragana-color "#f5c2e7")
  (skk-cursor-katakana-color "#a6e3a1")
  (skk-cursor-abbrev-color "#cba6f7")
