...
(custom-set-variables
 ...
 '(package-selected-packages
   '(bufferfile cape catppuccin-theme cider claude-code-ide
                ...
                format-all general groovy-mode helpful hl-todo
                jarchive marginalia multi-vterm nerd-icons-corfu
                orderless osx-dictionary presentation puni
                rainbow-delimiters restclient terraform-mode
                treemacs-evil treemacs-nerd-icons treemacs-perspective
                ultra-scroll undo-fu undo-fu-session vertico vundo
...
(custom-set-faces
 ...
 '(flymake-error-echo-at-eol ((t (:background "#744d5f" :foreground "#cad3f5" :box (:line-width (6 . -1) :color "#744d5f") :height 0.85))))
 '(flymake-note-echo-at-eol ((t (:background "#586e5e" :foreground "#cad3f5" :box (:line-width (6 . -1) :color "#586e5e") :height 0.85))))
 '(flymake-warning-echo-at-eol ((t (:background "#746355" :foreground "#cad3f5" :box (:line-width (6 . -1) :color "#746355") :height 0.85))))
