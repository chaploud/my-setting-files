...
;;;###theme-autoload
  (deftheme ef-catppuccin-macchiato
    "Cattppuccin Macchiato port for ef-themes."
...
further details)."
  ...
  (ef-themes-theme ef-catppuccin-macchiato ef-catppuccin-macchiato-palette ef-catppuccin-macchiato-palette-overrides)
